...
extern GLuint
stbgl_create_program(char const **vertex_source, char const **frag_source, char const **binds, char *error,
                     int error_buflen);
...
extern GLuint
stbgl_link_program(GLuint vertex_shader, GLuint fragment_shader, char const **binds, int num_binds, char *error,
                   int error_buflen);
...
extern void stbglVertexAttribPointer(GLuint index, GLint size, GLenum type, GLboolean normalized, GLsizei stride,
